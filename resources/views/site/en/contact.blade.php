<x-site.master title="Contact Us">
    <x-slot name="meta">
        <meta property="og:site_name" content="Jadwa Consulting and Business Solutions">
        <meta property="og:title" content=" Contact us and get your chance with Jadwa Partners for Success.">
        <meta property="twitter:title" content=" Contact us and get your chance with Jadwa Partners for Success.">
        <meta itemprop="name" content=" Contact us and get your chance with Jadwa Partners for Success.">
        ...
        <link rel="canonical" href="{{ route('site.en.index','contact') }}">
        <meta property="og:url" content="{{ route('site.en.index','contact') }}">
        <meta property="twitter:url" content="{{ route('site.en.index','contact') }}">
    ...
    <div class="bread-crumb">
        <div class="container">
            <div class="text"><a href="{{ route('home') }}">Home</a><i class="fa fa-angle-right"></i> Contact Us
            </div>
        </div>
    </div>
    <!-- bread crumb end -->

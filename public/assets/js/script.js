...
// const bartool = document.getElementById('bar_tool');
...
// var isShown = localStorage.getItem('status');
...
if (text.length > maxLength) {
  myParagraph.textContent = text.substring(0, maxLength) + "...";
}

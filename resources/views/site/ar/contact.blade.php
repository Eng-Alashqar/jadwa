<x-site.master-ar title="تواصل معنا">
    <x-slot name="meta">
        <meta property="og:site_name" content="جدوى للاستشارات وحلول الاعمال">
        <meta property="og:title" content=" تواصل معنا واحصل على فرصتك مع جدوى شركاء النجاح">
        <meta property="twitter:title" content=" تواصل معنا واحصل على فرصتك مع جدوى شركاء النجاح">
        <meta itemprop="name" content=" تواصل معنا واحصل على فرصتك مع جدوى شركاء النجاح">
        ...
        <link rel="canonical" href="{{ route('site.ar.index','contact') }}">
        <meta property="og:url" content="{{ route('site.ar.index','contact') }}">
        <meta property="twitter:url" content="{{ route('site.ar.index','contact') }}">
    ...
    <div class="bread-crumb">
        <div class="container">
            <div class="text"><a href="{{ route('home') }}">الرئيسية</a><i class="fa fa-angle-left"></i> تواصل معنا
            </div>
        </div>
    </div>
    <!-- bread crumb end -->

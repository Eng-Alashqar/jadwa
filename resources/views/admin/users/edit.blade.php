<x-admin.master title=" تعديل مستخدم">
    <x-page.title :route="route('admin.users.index')" title="المستخدمين" title_2="تعديل بيانات المستخدم" />
    {{-- @can('user-edit') --}}
            ...
            <x-form.card card_lable="تعديل بيانات المستخدم">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="SumoSelect" tabindex="0" role="button" aria-expanded="true">
                                <select multiple class="form-select" tabindex="-1" name="roles[]">
                                    @forelse ($roles as $i)
                                        <option value="{{ $i }}" @selected($userRole)>{{ $i }}
                                        </option>
                                    @empty
                                    @endforelse
                ...
                <x-slot name="footer">
                    <x-form.card-footer>
                        ...
                        <x-form.a :route="route('admin.users.index')" title="عودة الى الوراء"></x-form.a>
                    </x-form.card-footer>
                </x-slot>
